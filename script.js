...
window.onload=function main(){
  ...
  let button = document.getElementById('Puzzle');
  ...
  document.getElementById("Puzzle").addEventListener("click",mix);
...
let klik = document.getElementById("Puzzle");
klik.addEventListener("click",mix);
  ...
  var map = L.map('map').setView([53.447196,14.491953],15);
  marker.addTo(map);
